...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['ApiClient', 'model/InlineResponse400Error'], factory);
    } else if (typeof module === 'object' && module.exports) {
        // CommonJS-like environments that support module.exports, like Node.
        module.exports = factory(require('../ApiClient'), require('./InlineResponse400Error'));
    } else {
        // Browser globals (root is window)
        if (!root.WoleetSignatureBackendKit) {
            root.WoleetSignatureBackendKit = {};
        }
        root.WoleetSignatureBackendKit.InlineResponse400 = factory(root.WoleetSignatureBackendKit.ApiClient, root.WoleetSignatureBackendKit.InlineResponse400Error);
    }
}(this, function (ApiClient, InlineResponse400Error) {
    'use strict';
